...
export default function ActivityPage() {
  return (
    <main
      className={cn(
        "flex flex-col gap-6 pt-40 md:pt-50 pb-25 md:py-40 2xl:mx-25 2xl:py-70",
        "font-helvetica",
      )}
    >
      <section className={cn("flex flex-col justify-between gap-6")}>
        ...
        <article className="flex flex-col gap-3">
          <h6 className="text-[18px] font-bold md:text-[22px]">
            Издание «Книга Памяти»
          </h6>
          <p>
            По инициативе правления Ассоциации жертв политических репрессий
            «Номаран» (Память Имен), под руководством Аузби Борисовича Зураева,
            в период с 1999 по 2013 годы было издано шесть томов «Книги Памяти»
            — сборника, посвященного жертвам политических репрессий в
        ...
        <article className="flex flex-col gap-3">
          ...
          <p>
            Инициатором возведения этого мемориала стал председатель Объединения
      ...
      <section className="flex flex-col gap-3">
        ...
        <article className="flex justify-between">
          <p>
            ...
            имена 1620 жителей республики, расстрелянные в годы незаконных
