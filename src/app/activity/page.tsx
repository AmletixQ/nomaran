  ...
  return (
    ...
    >
      ...
      <section className="flex flex-col gap-3">
        ...
        <article className="flex justify-between">
          <p>
            Ежегодно 30 октября в день памяти жертв политических репрессий во
            Владикавказе у мемориала «Камень слез» по инициативе ассоциации
            «Номаран» проходит акция памяти жертв политических репрессий
            20-30-40- начала 50-ых годов XX века. В этот день сотни жителей
            республики приходят к мемориалу с цветами, чтобы почтить память
            родных и близких ставших невинными жертвами беззакония и произвола.
            На митинге, проходящем у мемориала выступают представители
            государственных органов, общественных организаций, религиозных
            объединений. Лейтмотивом всех выступлений звучит – &quot;Такое не должно
            повторится!&quot;
          </p>
        </article>
      </section>
