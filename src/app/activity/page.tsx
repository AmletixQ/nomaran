    ...
    >
      ...
      <section className="flex flex-col justify-between gap-5 md:flex-row md:gap-18">
        <article className="flex flex-col gap-5">
          ...
          <article className="flex flex-col gap-3">
            <h6 className="text-[22px] font-bold">Книга Памяти</h6>
          ...
          <article className="flex flex-col gap-3">
            ...
            <p>
              ...
              а рядом — колючая проволока, напоминающая о жестокости тех времён.
            </p>
            <p>
              Инициатором возведения этого мемориала стал председатель
              Объединения жертв политических репрессий «Номаран» — Аузби
              Борисович Зураев. Торжественное открытие состоялось 30 ноября 2005
              года, а автором этого памятника стал скульптор Георгий Сабеев.
            </p>
            <p>
